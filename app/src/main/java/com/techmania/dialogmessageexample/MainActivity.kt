package com.techmania.dialogmessageexample
...
import com.techmania.dialogmessageexample.ui.theme.DialogMessageExampleTheme
    ...
    Column(
        ...
        if (dialogStatus.value){
            ...
            AlertDialog(
                ...
                text = { Text(text = "Do you want to change the text color of the button?", color = Color.White, fontSize = 18.sp)},
